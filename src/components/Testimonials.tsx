...
export default function Testimonials() {
  ...
  return (
    <section id="contact" className="relative w-full py-12 md:py-20 lg:py-28 mb-[60px] lg:mb-[80px] bg-transparent overflow-hidden">
      ...
      <div className="container-wide relative z-10 font-sans">
        <motion.div
          ...
          {isLoading ? (
            ...
            testimonials.map((t, i) => (
              <motion.div
                ...
                className="h-full"
              >
                <TiltCard className="bg-white/5 backdrop-blur-2xl border border-white/10 p-6 md:p-8 rounded-3xl hover:border-blue-500/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.1)] transition-all duration-500 h-full w-full flex flex-col justify-between">
        ...
        >
          ...
          <div className="bg-white/5 backdrop-blur-2xl border border-white/10 p-6 md:p-8 rounded-3xl w-full">
